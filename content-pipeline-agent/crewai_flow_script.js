...
class NodeRenderer {
  ...
  drawNodeShape(ctx, x, y, width, height, scale, nodeStyle, opacity = 1.0, node = null) {
    ...
    const isDarkMode = document.documentElement.getAttribute('data-theme') === 'dark';
    const nodeData = {"check_seo": {"type": "listen", "trigger_methods": ["handle_make_blog"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "check_seo", "parameters": {}, "returns": {}}, "source_code": "    @listen(handle_make_blog)\n    def check_seo(self):\n        print(\"Checking Blog SEO\")\n", "source_lines": ["    @listen(handle_make_blog)\n", "    def check_seo(self):\n", "        print(\"Checking Blog SEO\")\n"], "source_start_line": 72, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 23, "class_name": "ContentPipelineFlow"}, "check_virality": {"type": "listen", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_condition": {"type": "OR", "conditions": ["handle_make_tweet", "handle_make_linkedin"]}, "trigger_methods": ["handle_make_tweet", "handle_make_linkedin"], "method_signature": {"operationId": "check_virality", "parameters": {}, "returns": {}}, "source_code": "    @listen(or_(handle_make_tweet, handle_make_linkedin))\n    def check_virality(self):\n        print(\"Checking Virality...\")\n", "source_lines": ["    @listen(or_(handle_make_tweet, handle_make_linkedin))\n", "    def check_virality(self):\n", "        print(\"Checking Virality...\")\n"], "source_start_line": 76, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 23, "class_name": "ContentPipelineFlow"}, "conduct_research": {"type": "listen", "trigger_methods": ["init_content_pipeline"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "conduct_research", "parameters": {}, "returns": {}}, "source_code": "    @listen(init_content_pipeline)\n    def conduct_research(self):\n        print(\"Researching...\")\n        return True\n", "source_lines": ["    @listen(init_content_pipeline)\n", "    def conduct_research(self):\n", "        print(\"Researching...\")\n", "        return True\n"], "source_start_line": 38, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 23, "class_name": "ContentPipelineFlow"}, "conduct_research_router": {"type": "router", "is_router": true, "router_paths": ["make_blog", "make_tweet", "make_linkedin"], "trigger_methods": ["conduct_research"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "conduct_research_router", "parameters": {}, "returns": {}}, "source_code": "    @router(conduct_research)\n    def conduct_research_router(self):\n        content_type = self.state.content_type\n\n        if content_type == \"blog\":\n            return \"make_blog\"\n        elif content_type == \"tweet\":\n            return \"make_tweet\"\n        else:\n            return \"make_linkedin\"\n", "source_lines": ["    @router(conduct_research)\n", "    def conduct_research_router(self):\n", "        content_type = self.state.content_type\n", "\n", "        if content_type == \"blog\":\n", "            return \"make_blog\"\n", "        elif content_type == \"tweet\":\n", "            return \"make_tweet\"\n", "        else:\n", "            return \"make_linkedin\"\n"], "source_start_line": 43, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 23, "class_name": "ContentPipelineFlow"}, "finalize_content": {"type": "listen", "trigger_methods": ["check_passed"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "finalize_content", "parameters": {}, "returns": {}}, "source_code": "    @listen(\"check_passed\")\n    def finalize_content(self):\n        print(\"Finalizing content\")\n", "source_lines": ["    @listen(\"check_passed\")\n", "    def finalize_content(self):\n", "        print(\"Finalizing content\")\n"], "source_start_line": 95, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 23, "class_name": "ContentPipelineFlow"}, "handle_make_blog": {"type": "listen", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_condition": {"type": "OR", "conditions": ["make_blog", "remake_blog"]}, "trigger_methods": ["make_blog", "remake_blog"], "method_signature": {"operationId": "handle_make_blog", "parameters": {}, "returns": {}}, "source_code": "    @listen(or_(\"make_blog\", \"remake_blog\"))\n    def handle_make_blog(self):\n        # \uc774 \ub0b4\ubd80\uc5d0\uc11c blog post\uac00 \uc774\uc804\uc5d0 \ub9cc\ub4e4\uc5b4\uc9c4 \uc801\uc774 \uc788\ub294\uc9c0 \ud655\uc778 \ud6c4 \uc608\uc804 \uac83\uc744 AI\uc5d0 \ubcf4\uc5ec\uc8fc\uba70 \uadf8\uac78 \uac1c\uc120\ud574 \ub2ec\ub77c\uace0 \uc694\uccad\n        # \uc774\uc804\uc5d0 \uc0dd\uc131\ub41c \uc801\uc774 \uc5c6\ub2e4\uba74 \uadf8\ub0e5 \uc0dd\uc131 \uc694\uccad\n        print(\"Making blog post...\")        \n", "source_lines": ["    @listen(or_(\"make_blog\", \"remake_blog\"))\n", "    def handle_make_blog(self):\n", "        # \uc774 \ub0b4\ubd80\uc5d0\uc11c blog post\uac00 \uc774\uc804\uc5d0 \ub9cc\ub4e4\uc5b4\uc9c4 \uc801\uc774 \uc788\ub294\uc9c0 \ud655\uc778 \ud6c4 \uc608\uc804 \uac83\uc744 AI\uc5d0 \ubcf4\uc5ec\uc8fc\uba70 \uadf8\uac78 \uac1c\uc120\ud574 \ub2ec\ub77c\uace0 \uc694\uccad\n", "        # \uc774\uc804\uc5d0 \uc0dd\uc131\ub41c \uc801\uc774 \uc5c6\ub2e4\uba74 \uadf8\ub0e5 \uc0dd\uc131 \uc694\uccad\n", "        print(\"Making blog post...\")        \n"], "source_start_line": 54, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 23, "class_name": "ContentPipelineFlow"}, "handle_make_linkedin": {"type": "listen", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_condition": {"type": "OR", "conditions": ["make_linkedin", "remake_linkedin"]}, "trigger_methods": ["make_linkedin", "remake_linkedin"], "method_signature": {"operationId": "handle_make_linkedin", "parameters": {}, "returns": {}}, "source_code": "    @listen(or_(\"make_linkedin\", \"remake_linkedin\"))\n    def handle_make_linkedin(self):\n        # \uc774 \ub0b4\ubd80\uc5d0\uc11c linkedin post\uac00 \uc774\uc804\uc5d0 \ub9cc\ub4e4\uc5b4\uc9c4 \uc801\uc774 \uc788\ub294\uc9c0 \ud655\uc778 \ud6c4 \uc608\uc804 \uac83\uc744 AI\uc5d0 \ubcf4\uc5ec\uc8fc\uba70 \uadf8\uac78 \uac1c\uc120\ud574 \ub2ec\ub77c\uace0 \uc694\uccad\n        # \uc774\uc804\uc5d0 \uc0dd\uc131\ub41c \uc801\uc774 \uc5c6\ub2e4\uba74 \uadf8\ub0e5 \uc0dd\uc131 \uc694\uccad\n        print(\"Making linkedin post...\")\n", "source_lines": ["    @listen(or_(\"make_linkedin\", \"remake_linkedin\"))\n", "    def handle_make_linkedin(self):\n", "        # \uc774 \ub0b4\ubd80\uc5d0\uc11c linkedin post\uac00 \uc774\uc804\uc5d0 \ub9cc\ub4e4\uc5b4\uc9c4 \uc801\uc774 \uc788\ub294\uc9c0 \ud655\uc778 \ud6c4 \uc608\uc804 \uac83\uc744 AI\uc5d0 \ubcf4\uc5ec\uc8fc\uba70 \uadf8\uac78 \uac1c\uc120\ud574 \ub2ec\ub77c\uace0 \uc694\uccad\n", "        # \uc774\uc804\uc5d0 \uc0dd\uc131\ub41c \uc801\uc774 \uc5c6\ub2e4\uba74 \uadf8\ub0e5 \uc0dd\uc131 \uc694\uccad\n", "        print(\"Making linkedin post...\")\n"], "source_start_line": 66, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 23, "class_name": "ContentPipelineFlow"}, "handle_make_tweet": {"type": "listen", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_condition": {"type": "OR", "conditions": ["make_tweet", "remake_tweet"]}, "trigger_methods": ["make_tweet", "remake_tweet"], "method_signature": {"operationId": "handle_make_tweet", "parameters": {}, "returns": {}}, "source_code": "    @listen(or_(\"make_tweet\", \"remake_tweet\"))\n    def handle_make_tweet(self):\n        # \uc774 \ub0b4\ubd80\uc5d0\uc11c tweet post\uac00 \uc774\uc804\uc5d0 \ub9cc\ub4e4\uc5b4\uc9c4 \uc801\uc774 \uc788\ub294\uc9c0 \ud655\uc778 \ud6c4 \uc608\uc804 \uac83\uc744 AI\uc5d0 \ubcf4\uc5ec\uc8fc\uba70 \uadf8\uac78 \uac1c\uc120\ud574 \ub2ec\ub77c\uace0 \uc694\uccad\n        # \uc774\uc804\uc5d0 \uc0dd\uc131\ub41c \uc801\uc774 \uc5c6\ub2e4\uba74 \uadf8\ub0e5 \uc0dd\uc131 \uc694\uccad\n        print(\"Making tweet post...\")        \n", "source_lines": ["    @listen(or_(\"make_tweet\", \"remake_tweet\"))\n", "    def handle_make_tweet(self):\n", "        # \uc774 \ub0b4\ubd80\uc5d0\uc11c tweet post\uac00 \uc774\uc804\uc5d0 \ub9cc\ub4e4\uc5b4\uc9c4 \uc801\uc774 \uc788\ub294\uc9c0 \ud655\uc778 \ud6c4 \uc608\uc804 \uac83\uc744 AI\uc5d0 \ubcf4\uc5ec\uc8fc\uba70 \uadf8\uac78 \uac1c\uc120\ud574 \ub2ec\ub77c\uace0 \uc694\uccad\n", "        # \uc774\uc804\uc5d0 \uc0dd\uc131\ub41c \uc801\uc774 \uc5c6\ub2e4\uba74 \uadf8\ub0e5 \uc0dd\uc131 \uc694\uccad\n", "        print(\"Making tweet post...\")        \n"], "source_start_line": 60, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 23, "class_name": "ContentPipelineFlow"}, "init_content_pipeline": {"type": "start", "method_signature": {"operationId": "init_content_pipeline", "parameters": {}, "returns": {}}, "source_code": "    @start()\n    def init_content_pipeline(self):\n        if self.state.content_type not in [\"tweet\", \"blog\", \"linkedin\"]:\n            raise ValueError(\"The content type is wrong\")\n        if self.state.topic == \"\":\n            raise ValueError(\"The topic can't be blank\")\n    \n        if self.state.content_type == \"tweet\":\n            self.state.max_length = 150\n        elif self.state.content_type == \"blog\":\n            self.state.max_length = 800\n        elif self.state.content_type == \"linkedin\":\n            self.state.max_length = 500\n", "source_lines": ["    @start()\n", "    def init_content_pipeline(self):\n", "        if self.state.content_type not in [\"tweet\", \"blog\", \"linkedin\"]:\n", "            raise ValueError(\"The content type is wrong\")\n", "        if self.state.topic == \"\":\n", "            raise ValueError(\"The topic can't be blank\")\n", "    \n", "        if self.state.content_type == \"tweet\":\n", "            self.state.max_length = 150\n", "        elif self.state.content_type == \"blog\":\n", "            self.state.max_length = 800\n", "        elif self.state.content_type == \"linkedin\":\n", "            self.state.max_length = 500\n"], "source_start_line": 24, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 23, "class_name": "ContentPipelineFlow"}, "score_router": {"type": "router", "is_router": true, "router_paths": ["remake_tweet", "check_passed", "remake_linkedin", "remake_blog"], "trigger_condition_type": "OR", "condition_type": "OR", "trigger_condition": {"type": "OR", "conditions": ["check_seo", "check_virality"]}, "trigger_methods": ["check_seo", "check_virality"], "method_signature": {"operationId": "score_router", "parameters": {}, "returns": {}}, "source_code": "    @router(or_(check_seo, check_virality))\n    def score_router(self):\n        content_type = self.state.content_type\n        score = self.state.score\n\n        if  score>= 8:\n            return \"check_passed\"\n        else:\n            if content_type == \"blog\":\n                return \"remake_blog\"\n            elif content_type == \"linkedin\":\n                return \"remake_linkedin\"\n            else:\n                return \"remake_tweet\"\n", "source_lines": ["    @router(or_(check_seo, check_virality))\n", "    def score_router(self):\n", "        content_type = self.state.content_type\n", "        score = self.state.score\n", "\n", "        if  score>= 8:\n", "            return \"check_passed\"\n", "        else:\n", "            if content_type == \"blog\":\n", "                return \"remake_blog\"\n", "            elif content_type == \"linkedin\":\n", "                return \"remake_linkedin\"\n", "            else:\n", "                return \"remake_tweet\"\n"], "source_start_line": 80, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 23, "class_name": "ContentPipelineFlow"}};
...
class NetworkManager {
  ...
  setupExportControls() {
    ...
    //   const dagData = {"nodes": {"check_seo": {"type": "listen", "trigger_methods": ["handle_make_blog"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "check_seo", "parameters": {}, "returns": {}}, "source_code": "    @listen(handle_make_blog)\n    def check_seo(self):\n        print(\"Checking Blog SEO\")\n", "source_lines": ["    @listen(handle_make_blog)\n", "    def check_seo(self):\n", "        print(\"Checking Blog SEO\")\n"], "source_start_line": 72, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 23, "class_name": "ContentPipelineFlow"}, "check_virality": {"type": "listen", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_condition": {"type": "OR", "conditions": ["handle_make_tweet", "handle_make_linkedin"]}, "trigger_methods": ["handle_make_tweet", "handle_make_linkedin"], "method_signature": {"operationId": "check_virality", "parameters": {}, "returns": {}}, "source_code": "    @listen(or_(handle_make_tweet, handle_make_linkedin))\n    def check_virality(self):\n        print(\"Checking Virality...\")\n", "source_lines": ["    @listen(or_(handle_make_tweet, handle_make_linkedin))\n", "    def check_virality(self):\n", "        print(\"Checking Virality...\")\n"], "source_start_line": 76, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 23, "class_name": "ContentPipelineFlow"}, "conduct_research": {"type": "listen", "trigger_methods": ["init_content_pipeline"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "conduct_research", "parameters": {}, "returns": {}}, "source_code": "    @listen(init_content_pipeline)\n    def conduct_research(self):\n        print(\"Researching...\")\n        return True\n", "source_lines": ["    @listen(init_content_pipeline)\n", "    def conduct_research(self):\n", "        print(\"Researching...\")\n", "        return True\n"], "source_start_line": 38, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 23, "class_name": "ContentPipelineFlow"}, "conduct_research_router": {"type": "router", "is_router": true, "router_paths": ["make_blog", "make_tweet", "make_linkedin"], "trigger_methods": ["conduct_research"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "conduct_research_router", "parameters": {}, "returns": {}}, "source_code": "    @router(conduct_research)\n    def conduct_research_router(self):\n        content_type = self.state.content_type\n\n        if content_type == \"blog\":\n            return \"make_blog\"\n        elif content_type == \"tweet\":\n            return \"make_tweet\"\n        else:\n            return \"make_linkedin\"\n", "source_lines": ["    @router(conduct_research)\n", "    def conduct_research_router(self):\n", "        content_type = self.state.content_type\n", "\n", "        if content_type == \"blog\":\n", "            return \"make_blog\"\n", "        elif content_type == \"tweet\":\n", "            return \"make_tweet\"\n", "        else:\n", "            return \"make_linkedin\"\n"], "source_start_line": 43, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 23, "class_name": "ContentPipelineFlow"}, "finalize_content": {"type": "listen", "trigger_methods": ["check_passed"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "finalize_content", "parameters": {}, "returns": {}}, "source_code": "    @listen(\"check_passed\")\n    def finalize_content(self):\n        print(\"Finalizing content\")\n", "source_lines": ["    @listen(\"check_passed\")\n", "    def finalize_content(self):\n", "        print(\"Finalizing content\")\n"], "source_start_line": 95, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 23, "class_name": "ContentPipelineFlow"}, "handle_make_blog": {"type": "listen", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_condition": {"type": "OR", "conditions": ["make_blog", "remake_blog"]}, "trigger_methods": ["make_blog", "remake_blog"], "method_signature": {"operationId": "handle_make_blog", "parameters": {}, "returns": {}}, "source_code": "    @listen(or_(\"make_blog\", \"remake_blog\"))\n    def handle_make_blog(self):\n        # \uc774 \ub0b4\ubd80\uc5d0\uc11c blog post\uac00 \uc774\uc804\uc5d0 \ub9cc\ub4e4\uc5b4\uc9c4 \uc801\uc774 \uc788\ub294\uc9c0 \ud655\uc778 \ud6c4 \uc608\uc804 \uac83\uc744 AI\uc5d0 \ubcf4\uc5ec\uc8fc\uba70 \uadf8\uac78 \uac1c\uc120\ud574 \ub2ec\ub77c\uace0 \uc694\uccad\n        # \uc774\uc804\uc5d0 \uc0dd\uc131\ub41c \uc801\uc774 \uc5c6\ub2e4\uba74 \uadf8\ub0e5 \uc0dd\uc131 \uc694\uccad\n        print(\"Making blog post...\")        \n", "source_lines": ["    @listen(or_(\"make_blog\", \"remake_blog\"))\n", "    def handle_make_blog(self):\n", "        # \uc774 \ub0b4\ubd80\uc5d0\uc11c blog post\uac00 \uc774\uc804\uc5d0 \ub9cc\ub4e4\uc5b4\uc9c4 \uc801\uc774 \uc788\ub294\uc9c0 \ud655\uc778 \ud6c4 \uc608\uc804 \uac83\uc744 AI\uc5d0 \ubcf4\uc5ec\uc8fc\uba70 \uadf8\uac78 \uac1c\uc120\ud574 \ub2ec\ub77c\uace0 \uc694\uccad\n", "        # \uc774\uc804\uc5d0 \uc0dd\uc131\ub41c \uc801\uc774 \uc5c6\ub2e4\uba74 \uadf8\ub0e5 \uc0dd\uc131 \uc694\uccad\n", "        print(\"Making blog post...\")        \n"], "source_start_line": 54, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 23, "class_name": "ContentPipelineFlow"}, "handle_make_linkedin": {"type": "listen", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_condition": {"type": "OR", "conditions": ["make_linkedin", "remake_linkedin"]}, "trigger_methods": ["make_linkedin", "remake_linkedin"], "method_signature": {"operationId": "handle_make_linkedin", "parameters": {}, "returns": {}}, "source_code": "    @listen(or_(\"make_linkedin\", \"remake_linkedin\"))\n    def handle_make_linkedin(self):\n        # \uc774 \ub0b4\ubd80\uc5d0\uc11c linkedin post\uac00 \uc774\uc804\uc5d0 \ub9cc\ub4e4\uc5b4\uc9c4 \uc801\uc774 \uc788\ub294\uc9c0 \ud655\uc778 \ud6c4 \uc608\uc804 \uac83\uc744 AI\uc5d0 \ubcf4\uc5ec\uc8fc\uba70 \uadf8\uac78 \uac1c\uc120\ud574 \ub2ec\ub77c\uace0 \uc694\uccad\n        # \uc774\uc804\uc5d0 \uc0dd\uc131\ub41c \uc801\uc774 \uc5c6\ub2e4\uba74 \uadf8\ub0e5 \uc0dd\uc131 \uc694\uccad\n        print(\"Making linkedin post...\")\n", "source_lines": ["    @listen(or_(\"make_linkedin\", \"remake_linkedin\"))\n", "    def handle_make_linkedin(self):\n", "        # \uc774 \ub0b4\ubd80\uc5d0\uc11c linkedin post\uac00 \uc774\uc804\uc5d0 \ub9cc\ub4e4\uc5b4\uc9c4 \uc801\uc774 \uc788\ub294\uc9c0 \ud655\uc778 \ud6c4 \uc608\uc804 \uac83\uc744 AI\uc5d0 \ubcf4\uc5ec\uc8fc\uba70 \uadf8\uac78 \uac1c\uc120\ud574 \ub2ec\ub77c\uace0 \uc694\uccad\n", "        # \uc774\uc804\uc5d0 \uc0dd\uc131\ub41c \uc801\uc774 \uc5c6\ub2e4\uba74 \uadf8\ub0e5 \uc0dd\uc131 \uc694\uccad\n", "        print(\"Making linkedin post...\")\n"], "source_start_line": 66, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 23, "class_name": "ContentPipelineFlow"}, "handle_make_tweet": {"type": "listen", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_condition": {"type": "OR", "conditions": ["make_tweet", "remake_tweet"]}, "trigger_methods": ["make_tweet", "remake_tweet"], "method_signature": {"operationId": "handle_make_tweet", "parameters": {}, "returns": {}}, "source_code": "    @listen(or_(\"make_tweet\", \"remake_tweet\"))\n    def handle_make_tweet(self):\n        # \uc774 \ub0b4\ubd80\uc5d0\uc11c tweet post\uac00 \uc774\uc804\uc5d0 \ub9cc\ub4e4\uc5b4\uc9c4 \uc801\uc774 \uc788\ub294\uc9c0 \ud655\uc778 \ud6c4 \uc608\uc804 \uac83\uc744 AI\uc5d0 \ubcf4\uc5ec\uc8fc\uba70 \uadf8\uac78 \uac1c\uc120\ud574 \ub2ec\ub77c\uace0 \uc694\uccad\n        # \uc774\uc804\uc5d0 \uc0dd\uc131\ub41c \uc801\uc774 \uc5c6\ub2e4\uba74 \uadf8\ub0e5 \uc0dd\uc131 \uc694\uccad\n        print(\"Making tweet post...\")        \n", "source_lines": ["    @listen(or_(\"make_tweet\", \"remake_tweet\"))\n", "    def handle_make_tweet(self):\n", "        # \uc774 \ub0b4\ubd80\uc5d0\uc11c tweet post\uac00 \uc774\uc804\uc5d0 \ub9cc\ub4e4\uc5b4\uc9c4 \uc801\uc774 \uc788\ub294\uc9c0 \ud655\uc778 \ud6c4 \uc608\uc804 \uac83\uc744 AI\uc5d0 \ubcf4\uc5ec\uc8fc\uba70 \uadf8\uac78 \uac1c\uc120\ud574 \ub2ec\ub77c\uace0 \uc694\uccad\n", "        # \uc774\uc804\uc5d0 \uc0dd\uc131\ub41c \uc801\uc774 \uc5c6\ub2e4\uba74 \uadf8\ub0e5 \uc0dd\uc131 \uc694\uccad\n", "        print(\"Making tweet post...\")        \n"], "source_start_line": 60, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 23, "class_name": "ContentPipelineFlow"}, "init_content_pipeline": {"type": "start", "method_signature": {"operationId": "init_content_pipeline", "parameters": {}, "returns": {}}, "source_code": "    @start()\n    def init_content_pipeline(self):\n        if self.state.content_type not in [\"tweet\", \"blog\", \"linkedin\"]:\n            raise ValueError(\"The content type is wrong\")\n        if self.state.topic == \"\":\n            raise ValueError(\"The topic can't be blank\")\n    \n        if self.state.content_type == \"tweet\":\n            self.state.max_length = 150\n        elif self.state.content_type == \"blog\":\n            self.state.max_length = 800\n        elif self.state.content_type == \"linkedin\":\n            self.state.max_length = 500\n", "source_lines": ["    @start()\n", "    def init_content_pipeline(self):\n", "        if self.state.content_type not in [\"tweet\", \"blog\", \"linkedin\"]:\n", "            raise ValueError(\"The content type is wrong\")\n", "        if self.state.topic == \"\":\n", "            raise ValueError(\"The topic can't be blank\")\n", "    \n", "        if self.state.content_type == \"tweet\":\n", "            self.state.max_length = 150\n", "        elif self.state.content_type == \"blog\":\n", "            self.state.max_length = 800\n", "        elif self.state.content_type == \"linkedin\":\n", "            self.state.max_length = 500\n"], "source_start_line": 24, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 23, "class_name": "ContentPipelineFlow"}, "score_router": {"type": "router", "is_router": true, "router_paths": ["remake_tweet", "check_passed", "remake_linkedin", "remake_blog"], "trigger_condition_type": "OR", "condition_type": "OR", "trigger_condition": {"type": "OR", "conditions": ["check_seo", "check_virality"]}, "trigger_methods": ["check_seo", "check_virality"], "method_signature": {"operationId": "score_router", "parameters": {}, "returns": {}}, "source_code": "    @router(or_(check_seo, check_virality))\n    def score_router(self):\n        content_type = self.state.content_type\n        score = self.state.score\n\n        if  score>= 8:\n            return \"check_passed\"\n        else:\n            if content_type == \"blog\":\n                return \"remake_blog\"\n            elif content_type == \"linkedin\":\n                return \"remake_linkedin\"\n            else:\n                return \"remake_tweet\"\n", "source_lines": ["    @router(or_(check_seo, check_virality))\n", "    def score_router(self):\n", "        content_type = self.state.content_type\n", "        score = self.state.score\n", "\n", "        if  score>= 8:\n", "            return \"check_passed\"\n", "        else:\n", "            if content_type == \"blog\":\n", "                return \"remake_blog\"\n", "            elif content_type == \"linkedin\":\n", "                return \"remake_linkedin\"\n", "            else:\n", "                return \"remake_tweet\"\n"], "source_start_line": 80, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 23, "class_name": "ContentPipelineFlow"}}, "edges": [{"source": "init_content_pipeline", "target": "conduct_research", "condition_type": "OR", "is_router_path": false}, {"source": "handle_make_blog", "target": "check_seo", "condition_type": "OR", "is_router_path": false}, {"source": "handle_make_tweet", "target": "check_virality", "condition_type": "OR", "is_router_path": false}, {"source": "handle_make_linkedin", "target": "check_virality", "condition_type": "OR", "is_router_path": false}, {"source": "conduct_research", "target": "conduct_research_router", "condition_type": "OR", "is_router_path": false}, {"source": "check_seo", "target": "score_router", "condition_type": "OR", "is_router_path": false}, {"source": "check_virality", "target": "score_router", "condition_type": "OR", "is_router_path": false}, {"source": "conduct_research_router", "target": "handle_make_blog", "condition_type": null, "is_router_path": true, "router_path_label": "make_blog"}, {"source": "conduct_research_router", "target": "handle_make_tweet", "condition_type": null, "is_router_path": true, "router_path_label": "make_tweet"}, {"source": "conduct_research_router", "target": "handle_make_linkedin", "condition_type": null, "is_router_path": true, "router_path_label": "make_linkedin"}, {"source": "score_router", "target": "handle_make_tweet", "condition_type": null, "is_router_path": true, "router_path_label": "remake_tweet"}, {"source": "score_router", "target": "finalize_content", "condition_type": null, "is_router_path": true, "router_path_label": "check_passed"}, {"source": "score_router", "target": "handle_make_linkedin", "condition_type": null, "is_router_path": true, "router_path_label": "remake_linkedin"}, {"source": "score_router", "target": "handle_make_blog", "condition_type": null, "is_router_path": true, "router_path_label": "remake_blog"}], "start_methods": ["init_content_pipeline"], "router_methods": ["conduct_research_router", "score_router"]};
