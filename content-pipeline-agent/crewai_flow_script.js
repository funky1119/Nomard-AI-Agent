...
class NodeRenderer {
  ...
  drawNodeShape(ctx, x, y, width, height, scale, nodeStyle, opacity = 1.0, node = null) {
    ...
    const isDarkMode = document.documentElement.getAttribute('data-theme') === 'dark';
    const nodeData = {"final": {"type": "listen", "trigger_methods": ["second", "third"], "trigger_condition_type": "AND", "condition_type": "AND", "trigger_condition": {"type": "AND", "conditions": ["second", "third"]}, "method_signature": {"operationId": "final", "parameters": {}, "returns": {}}, "source_code": "    @listen(and_(second, third))\n    def final(self):        \n        print(':)')\n", "source_lines": ["    @listen(and_(second, third))\n", "    def final(self):        \n", "        print(':)')\n"], "source_start_line": 27, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class MyFirstFlow(Flow[MyFirstFlowState])", "class_line_number": 12, "class_name": "MyFirstFlow"}, "first": {"type": "start", "method_signature": {"operationId": "first", "parameters": {}, "returns": {}}, "source_code": "    @start()\n    def first(self):\n        print(self.state.user_id)\n        print('hHello')\n", "source_lines": ["    @start()\n", "    def first(self):\n", "        print(self.state.user_id)\n", "        print('hHello')\n"], "source_start_line": 13, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class MyFirstFlow(Flow[MyFirstFlowState])", "class_line_number": 12, "class_name": "MyFirstFlow"}, "handle_even": {"type": "listen", "trigger_methods": ["even"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "handle_even", "parameters": {}, "returns": {}}, "source_code": "    @listen('even')\n    def handle_even(self):\n        print(\"even\")\n", "source_lines": ["    @listen('even')\n", "    def handle_even(self):\n", "        print(\"even\")\n"], "source_start_line": 38, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class MyFirstFlow(Flow[MyFirstFlowState])", "class_line_number": 12, "class_name": "MyFirstFlow"}, "handle_odd": {"type": "listen", "trigger_methods": ["odd"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "handle_odd", "parameters": {}, "returns": {}}, "source_code": "    @listen('odd')\n    def handle_odd(self):\n        print(\"eidd\")\n", "source_lines": ["    @listen('odd')\n", "    def handle_odd(self):\n", "        print(\"eidd\")\n"], "source_start_line": 42, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class MyFirstFlow(Flow[MyFirstFlowState])", "class_line_number": 12, "class_name": "MyFirstFlow"}, "route": {"type": "router", "is_router": true, "router_paths": ["even", "odd"], "trigger_methods": ["final"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "route", "parameters": {}, "returns": {}}, "source_code": "    @router(final)\n    def route(self):\n        if self.state.is_admin:\n            return \"even\"\n        else:\n            return \"odd\"\n", "source_lines": ["    @router(final)\n", "    def route(self):\n", "        if self.state.is_admin:\n", "            return \"even\"\n", "        else:\n", "            return \"odd\"\n"], "source_start_line": 31, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class MyFirstFlow(Flow[MyFirstFlowState])", "class_line_number": 12, "class_name": "MyFirstFlow"}, "second": {"type": "listen", "trigger_methods": ["first"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "second", "parameters": {}, "returns": {}}, "source_code": "    @listen(first)\n    def second(self):\n        self.state.user_id = 3\n        print('world')\n", "source_lines": ["    @listen(first)\n", "    def second(self):\n", "        self.state.user_id = 3\n", "        print('world')\n"], "source_start_line": 18, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class MyFirstFlow(Flow[MyFirstFlowState])", "class_line_number": 12, "class_name": "MyFirstFlow"}, "third": {"type": "listen", "trigger_methods": ["first"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "third", "parameters": {}, "returns": {}}, "source_code": "    @listen(first)\n    def third(self):\n        print('!')\n", "source_lines": ["    @listen(first)\n", "    def third(self):\n", "        print('!')\n"], "source_start_line": 23, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class MyFirstFlow(Flow[MyFirstFlowState])", "class_line_number": 12, "class_name": "MyFirstFlow"}};
...
class NetworkManager {
  ...
  setupExportControls() {
    ...
    //   const dagData = {"nodes": {"final": {"type": "listen", "trigger_methods": ["second", "third"], "trigger_condition_type": "AND", "condition_type": "AND", "trigger_condition": {"type": "AND", "conditions": ["second", "third"]}, "method_signature": {"operationId": "final", "parameters": {}, "returns": {}}, "source_code": "    @listen(and_(second, third))\n    def final(self):        \n        print(':)')\n", "source_lines": ["    @listen(and_(second, third))\n", "    def final(self):        \n", "        print(':)')\n"], "source_start_line": 27, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class MyFirstFlow(Flow[MyFirstFlowState])", "class_line_number": 12, "class_name": "MyFirstFlow"}, "first": {"type": "start", "method_signature": {"operationId": "first", "parameters": {}, "returns": {}}, "source_code": "    @start()\n    def first(self):\n        print(self.state.user_id)\n        print('hHello')\n", "source_lines": ["    @start()\n", "    def first(self):\n", "        print(self.state.user_id)\n", "        print('hHello')\n"], "source_start_line": 13, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class MyFirstFlow(Flow[MyFirstFlowState])", "class_line_number": 12, "class_name": "MyFirstFlow"}, "handle_even": {"type": "listen", "trigger_methods": ["even"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "handle_even", "parameters": {}, "returns": {}}, "source_code": "    @listen('even')\n    def handle_even(self):\n        print(\"even\")\n", "source_lines": ["    @listen('even')\n", "    def handle_even(self):\n", "        print(\"even\")\n"], "source_start_line": 38, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class MyFirstFlow(Flow[MyFirstFlowState])", "class_line_number": 12, "class_name": "MyFirstFlow"}, "handle_odd": {"type": "listen", "trigger_methods": ["odd"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "handle_odd", "parameters": {}, "returns": {}}, "source_code": "    @listen('odd')\n    def handle_odd(self):\n        print(\"eidd\")\n", "source_lines": ["    @listen('odd')\n", "    def handle_odd(self):\n", "        print(\"eidd\")\n"], "source_start_line": 42, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class MyFirstFlow(Flow[MyFirstFlowState])", "class_line_number": 12, "class_name": "MyFirstFlow"}, "route": {"type": "router", "is_router": true, "router_paths": ["even", "odd"], "trigger_methods": ["final"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "route", "parameters": {}, "returns": {}}, "source_code": "    @router(final)\n    def route(self):\n        if self.state.is_admin:\n            return \"even\"\n        else:\n            return \"odd\"\n", "source_lines": ["    @router(final)\n", "    def route(self):\n", "        if self.state.is_admin:\n", "            return \"even\"\n", "        else:\n", "            return \"odd\"\n"], "source_start_line": 31, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class MyFirstFlow(Flow[MyFirstFlowState])", "class_line_number": 12, "class_name": "MyFirstFlow"}, "second": {"type": "listen", "trigger_methods": ["first"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "second", "parameters": {}, "returns": {}}, "source_code": "    @listen(first)\n    def second(self):\n        self.state.user_id = 3\n        print('world')\n", "source_lines": ["    @listen(first)\n", "    def second(self):\n", "        self.state.user_id = 3\n", "        print('world')\n"], "source_start_line": 18, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class MyFirstFlow(Flow[MyFirstFlowState])", "class_line_number": 12, "class_name": "MyFirstFlow"}, "third": {"type": "listen", "trigger_methods": ["first"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "third", "parameters": {}, "returns": {}}, "source_code": "    @listen(first)\n    def third(self):\n        print('!')\n", "source_lines": ["    @listen(first)\n", "    def third(self):\n", "        print('!')\n"], "source_start_line": 23, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class MyFirstFlow(Flow[MyFirstFlowState])", "class_line_number": 12, "class_name": "MyFirstFlow"}}, "edges": [{"source": "first", "target": "second", "condition_type": "OR", "is_router_path": false}, {"source": "first", "target": "third", "condition_type": "OR", "is_router_path": false}, {"source": "second", "target": "final", "condition_type": "AND", "is_router_path": false}, {"source": "third", "target": "final", "condition_type": "AND", "is_router_path": false}, {"source": "final", "target": "route", "condition_type": "OR", "is_router_path": false}, {"source": "route", "target": "handle_even", "condition_type": null, "is_router_path": true, "router_path_label": "even"}, {"source": "route", "target": "handle_odd", "condition_type": null, "is_router_path": true, "router_path_label": "odd"}], "start_methods": ["first"], "router_methods": ["route"]};
