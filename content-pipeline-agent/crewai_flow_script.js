...
class NodeRenderer {
  ...
  drawNodeShape(ctx, x, y, width, height, scale, nodeStyle, opacity = 1.0, node = null) {
    ...
    const isDarkMode = document.documentElement.getAttribute('data-theme') === 'dark';
    const nodeData = {"check_seo": {"type": "listen", "trigger_methods": ["handle_make_blog"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "check_seo", "parameters": {}, "returns": {}}, "source_code": "    @listen(handle_make_blog)\n    def check_seo(self):\n        print(\"Checking Blog SEO\")\n", "source_lines": ["    @listen(handle_make_blog)\n", "    def check_seo(self):\n", "        print(\"Checking Blog SEO\")\n"], "source_start_line": 60, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 17, "class_name": "ContentPipelineFlow"}, "check_virality": {"type": "listen", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_condition": {"type": "OR", "conditions": ["handle_make_tweet", "handle_make_linkedin_post"]}, "trigger_methods": ["handle_make_tweet", "handle_make_linkedin_post"], "method_signature": {"operationId": "check_virality", "parameters": {}, "returns": {}}, "source_code": "    @listen(or_(handle_make_tweet, handle_make_linkedin_post))\n    def check_virality(self):\n        print(\"Checking Virality...\")\n", "source_lines": ["    @listen(or_(handle_make_tweet, handle_make_linkedin_post))\n", "    def check_virality(self):\n", "        print(\"Checking Virality...\")\n"], "source_start_line": 64, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 17, "class_name": "ContentPipelineFlow"}, "conduct_research": {"type": "listen", "trigger_methods": ["init_content_pipeline"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "conduct_research", "parameters": {}, "returns": {}}, "source_code": "    @listen(init_content_pipeline)\n    def conduct_research(self):\n        print(\"Researching...\")\n        return True\n", "source_lines": ["    @listen(init_content_pipeline)\n", "    def conduct_research(self):\n", "        print(\"Researching...\")\n", "        return True\n"], "source_start_line": 32, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 17, "class_name": "ContentPipelineFlow"}, "finalize_content": {"type": "listen", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_condition": {"type": "OR", "conditions": ["check_seo", "check_virality"]}, "trigger_methods": ["check_seo", "check_virality"], "method_signature": {"operationId": "finalize_content", "parameters": {}, "returns": {}}, "source_code": "    @listen(or_(check_seo, check_virality))\n    def finalize_content(self):\n        print(\"Finalizing content\")\n", "source_lines": ["    @listen(or_(check_seo, check_virality))\n", "    def finalize_content(self):\n", "        print(\"Finalizing content\")\n"], "source_start_line": 68, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 17, "class_name": "ContentPipelineFlow"}, "handle_make_blog": {"type": "listen", "trigger_methods": ["make_blog"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "handle_make_blog", "parameters": {}, "returns": {}}, "source_code": "    @listen(\"make_blog\")\n    def handle_make_blog(self):\n        print(\"Making blog post...\")        \n", "source_lines": ["    @listen(\"make_blog\")\n", "    def handle_make_blog(self):\n", "        print(\"Making blog post...\")        \n"], "source_start_line": 48, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 17, "class_name": "ContentPipelineFlow"}, "handle_make_linkedin_post": {"type": "listen", "trigger_methods": ["make_linkedin_post"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "handle_make_linkedin_post", "parameters": {}, "returns": {}}, "source_code": "    @listen(\"make_linkedin_post\")\n    def handle_make_linkedin_post(self):\n        print(\"Making linkedin post...\")\n", "source_lines": ["    @listen(\"make_linkedin_post\")\n", "    def handle_make_linkedin_post(self):\n", "        print(\"Making linkedin post...\")\n"], "source_start_line": 56, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 17, "class_name": "ContentPipelineFlow"}, "handle_make_tweet": {"type": "listen", "trigger_methods": ["make_tweet"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "handle_make_tweet", "parameters": {}, "returns": {}}, "source_code": "    @listen(\"make_tweet\")\n    def handle_make_tweet(self):\n        print(\"Making tweet post...\")        \n", "source_lines": ["    @listen(\"make_tweet\")\n", "    def handle_make_tweet(self):\n", "        print(\"Making tweet post...\")        \n"], "source_start_line": 52, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 17, "class_name": "ContentPipelineFlow"}, "init_content_pipeline": {"type": "start", "method_signature": {"operationId": "init_content_pipeline", "parameters": {}, "returns": {}}, "source_code": "    @start()\n    def init_content_pipeline(self):\n        if self.state.content_type not in [\"tweet\", \"blog\", \"linkedin\"]:\n            raise ValueError(\"The content type is wrong\")\n        if self.state.topic == \"\":\n            raise ValueError(\"The topic can't be blank\")\n    \n        if self.state.content_type == \"tweet\":\n            self.state.max_length = 150\n        elif self.state.content_type == \"blog\":\n            self.state.max_length = 800\n        elif self.state.content_type == \"linkedin\":\n            self.state.max_length = 500\n", "source_lines": ["    @start()\n", "    def init_content_pipeline(self):\n", "        if self.state.content_type not in [\"tweet\", \"blog\", \"linkedin\"]:\n", "            raise ValueError(\"The content type is wrong\")\n", "        if self.state.topic == \"\":\n", "            raise ValueError(\"The topic can't be blank\")\n", "    \n", "        if self.state.content_type == \"tweet\":\n", "            self.state.max_length = 150\n", "        elif self.state.content_type == \"blog\":\n", "            self.state.max_length = 800\n", "        elif self.state.content_type == \"linkedin\":\n", "            self.state.max_length = 500\n"], "source_start_line": 18, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 17, "class_name": "ContentPipelineFlow"}, "router": {"type": "router", "is_router": true, "router_paths": ["make_blog", "make_tweet", "make_linkedin_post"], "trigger_methods": ["conduct_research"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "router", "parameters": {}, "returns": {}}, "source_code": "    @router(conduct_research)\n    def router(self):\n        content_type = self.state.content_type\n\n        if content_type == \"blog\":\n            return \"make_blog\"\n        elif content_type == \"tweet\":\n            return \"make_tweet\"\n        else:\n            return \"make_linkedin_post\"\n", "source_lines": ["    @router(conduct_research)\n", "    def router(self):\n", "        content_type = self.state.content_type\n", "\n", "        if content_type == \"blog\":\n", "            return \"make_blog\"\n", "        elif content_type == \"tweet\":\n", "            return \"make_tweet\"\n", "        else:\n", "            return \"make_linkedin_post\"\n"], "source_start_line": 37, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 17, "class_name": "ContentPipelineFlow"}};
...
class NetworkManager {
  ...
  async initialize() {
    try {
      ...
      this.edges = new vis.DataSet([{"from": "init_content_pipeline", "to": "conduct_research", "label": "OR", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#666666", "highlight": "#666666"}}, {"from": "handle_make_blog", "to": "check_seo", "label": "OR", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#666666", "highlight": "#666666"}}, {"from": "handle_make_tweet", "to": "check_virality", "label": "OR", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#666666", "highlight": "#666666"}}, {"from": "handle_make_linkedin_post", "to": "check_virality", "label": "OR", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#666666", "highlight": "#666666"}}, {"from": "check_seo", "to": "finalize_content", "label": "OR", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#666666", "highlight": "#666666"}}, {"from": "check_virality", "to": "finalize_content", "label": "OR", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#666666", "highlight": "#666666"}}, {"from": "conduct_research", "to": "router", "label": "OR", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#666666", "highlight": "#666666"}}, {"from": "router", "to": "handle_make_blog", "label": "make_blog", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#FF5A50", "highlight": "#FF5A50"}, "dashes": [15, 10]}, {"from": "router", "to": "handle_make_tweet", "label": "make_tweet", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#FF5A50", "highlight": "#FF5A50"}, "dashes": [15, 10]}, {"from": "router", "to": "handle_make_linkedin_post", "label": "make_linkedin_post", "arrows": "to", "width": 2, "selectionWidth": 0, "color": {"color": "#FF5A50", "highlight": "#FF5A50"}, "dashes": [15, 10]}]);
  ...
  setupExportControls() {
    ...
    //   const dagData = {"nodes": {"check_seo": {"type": "listen", "trigger_methods": ["handle_make_blog"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "check_seo", "parameters": {}, "returns": {}}, "source_code": "    @listen(handle_make_blog)\n    def check_seo(self):\n        print(\"Checking Blog SEO\")\n", "source_lines": ["    @listen(handle_make_blog)\n", "    def check_seo(self):\n", "        print(\"Checking Blog SEO\")\n"], "source_start_line": 60, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 17, "class_name": "ContentPipelineFlow"}, "check_virality": {"type": "listen", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_condition": {"type": "OR", "conditions": ["handle_make_tweet", "handle_make_linkedin_post"]}, "trigger_methods": ["handle_make_tweet", "handle_make_linkedin_post"], "method_signature": {"operationId": "check_virality", "parameters": {}, "returns": {}}, "source_code": "    @listen(or_(handle_make_tweet, handle_make_linkedin_post))\n    def check_virality(self):\n        print(\"Checking Virality...\")\n", "source_lines": ["    @listen(or_(handle_make_tweet, handle_make_linkedin_post))\n", "    def check_virality(self):\n", "        print(\"Checking Virality...\")\n"], "source_start_line": 64, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 17, "class_name": "ContentPipelineFlow"}, "conduct_research": {"type": "listen", "trigger_methods": ["init_content_pipeline"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "conduct_research", "parameters": {}, "returns": {}}, "source_code": "    @listen(init_content_pipeline)\n    def conduct_research(self):\n        print(\"Researching...\")\n        return True\n", "source_lines": ["    @listen(init_content_pipeline)\n", "    def conduct_research(self):\n", "        print(\"Researching...\")\n", "        return True\n"], "source_start_line": 32, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 17, "class_name": "ContentPipelineFlow"}, "finalize_content": {"type": "listen", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_condition": {"type": "OR", "conditions": ["check_seo", "check_virality"]}, "trigger_methods": ["check_seo", "check_virality"], "method_signature": {"operationId": "finalize_content", "parameters": {}, "returns": {}}, "source_code": "    @listen(or_(check_seo, check_virality))\n    def finalize_content(self):\n        print(\"Finalizing content\")\n", "source_lines": ["    @listen(or_(check_seo, check_virality))\n", "    def finalize_content(self):\n", "        print(\"Finalizing content\")\n"], "source_start_line": 68, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 17, "class_name": "ContentPipelineFlow"}, "handle_make_blog": {"type": "listen", "trigger_methods": ["make_blog"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "handle_make_blog", "parameters": {}, "returns": {}}, "source_code": "    @listen(\"make_blog\")\n    def handle_make_blog(self):\n        print(\"Making blog post...\")        \n", "source_lines": ["    @listen(\"make_blog\")\n", "    def handle_make_blog(self):\n", "        print(\"Making blog post...\")        \n"], "source_start_line": 48, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 17, "class_name": "ContentPipelineFlow"}, "handle_make_linkedin_post": {"type": "listen", "trigger_methods": ["make_linkedin_post"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "handle_make_linkedin_post", "parameters": {}, "returns": {}}, "source_code": "    @listen(\"make_linkedin_post\")\n    def handle_make_linkedin_post(self):\n        print(\"Making linkedin post...\")\n", "source_lines": ["    @listen(\"make_linkedin_post\")\n", "    def handle_make_linkedin_post(self):\n", "        print(\"Making linkedin post...\")\n"], "source_start_line": 56, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 17, "class_name": "ContentPipelineFlow"}, "handle_make_tweet": {"type": "listen", "trigger_methods": ["make_tweet"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "handle_make_tweet", "parameters": {}, "returns": {}}, "source_code": "    @listen(\"make_tweet\")\n    def handle_make_tweet(self):\n        print(\"Making tweet post...\")        \n", "source_lines": ["    @listen(\"make_tweet\")\n", "    def handle_make_tweet(self):\n", "        print(\"Making tweet post...\")        \n"], "source_start_line": 52, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 17, "class_name": "ContentPipelineFlow"}, "init_content_pipeline": {"type": "start", "method_signature": {"operationId": "init_content_pipeline", "parameters": {}, "returns": {}}, "source_code": "    @start()\n    def init_content_pipeline(self):\n        if self.state.content_type not in [\"tweet\", \"blog\", \"linkedin\"]:\n            raise ValueError(\"The content type is wrong\")\n        if self.state.topic == \"\":\n            raise ValueError(\"The topic can't be blank\")\n    \n        if self.state.content_type == \"tweet\":\n            self.state.max_length = 150\n        elif self.state.content_type == \"blog\":\n            self.state.max_length = 800\n        elif self.state.content_type == \"linkedin\":\n            self.state.max_length = 500\n", "source_lines": ["    @start()\n", "    def init_content_pipeline(self):\n", "        if self.state.content_type not in [\"tweet\", \"blog\", \"linkedin\"]:\n", "            raise ValueError(\"The content type is wrong\")\n", "        if self.state.topic == \"\":\n", "            raise ValueError(\"The topic can't be blank\")\n", "    \n", "        if self.state.content_type == \"tweet\":\n", "            self.state.max_length = 150\n", "        elif self.state.content_type == \"blog\":\n", "            self.state.max_length = 800\n", "        elif self.state.content_type == \"linkedin\":\n", "            self.state.max_length = 500\n"], "source_start_line": 18, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 17, "class_name": "ContentPipelineFlow"}, "router": {"type": "router", "is_router": true, "router_paths": ["make_blog", "make_tweet", "make_linkedin_post"], "trigger_methods": ["conduct_research"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "router", "parameters": {}, "returns": {}}, "source_code": "    @router(conduct_research)\n    def router(self):\n        content_type = self.state.content_type\n\n        if content_type == \"blog\":\n            return \"make_blog\"\n        elif content_type == \"tweet\":\n            return \"make_tweet\"\n        else:\n            return \"make_linkedin_post\"\n", "source_lines": ["    @router(conduct_research)\n", "    def router(self):\n", "        content_type = self.state.content_type\n", "\n", "        if content_type == \"blog\":\n", "            return \"make_blog\"\n", "        elif content_type == \"tweet\":\n", "            return \"make_tweet\"\n", "        else:\n", "            return \"make_linkedin_post\"\n"], "source_start_line": 37, "source_file": "D:\\workspace\\AI-AGENT-NOMARD\\Nomard-AI-Agent\\content-pipeline-agent\\main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 17, "class_name": "ContentPipelineFlow"}}, "edges": [{"source": "init_content_pipeline", "target": "conduct_research", "condition_type": "OR", "is_router_path": false}, {"source": "handle_make_blog", "target": "check_seo", "condition_type": "OR", "is_router_path": false}, {"source": "handle_make_tweet", "target": "check_virality", "condition_type": "OR", "is_router_path": false}, {"source": "handle_make_linkedin_post", "target": "check_virality", "condition_type": "OR", "is_router_path": false}, {"source": "check_seo", "target": "finalize_content", "condition_type": "OR", "is_router_path": false}, {"source": "check_virality", "target": "finalize_content", "condition_type": "OR", "is_router_path": false}, {"source": "conduct_research", "target": "router", "condition_type": "OR", "is_router_path": false}, {"source": "router", "target": "handle_make_blog", "condition_type": null, "is_router_path": true, "router_path_label": "make_blog"}, {"source": "router", "target": "handle_make_tweet", "condition_type": null, "is_router_path": true, "router_path_label": "make_tweet"}, {"source": "router", "target": "handle_make_linkedin_post", "condition_type": null, "is_router_path": true, "router_path_label": "make_linkedin_post"}], "start_methods": ["init_content_pipeline"], "router_methods": ["router"]};
